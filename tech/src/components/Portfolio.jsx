...
const PROJECTS = [
  {
    id: 'vanguard',
    title: 'Vanguard Motors — Demo CMS',
    category: 'Web Development',
    tags: ['React', 'Node.js', 'Tailwind CSS'],
    image: '/projects/car_dealers.png',
    description: 'A premium automotive dealership demo site for luxury/performance cars.',
    fullDescription: 'A premium automotive dealership demo site built to show off a luxury/performance car inventory with a clean, high-end browsing experience — curated listings, hand-inspected vehicle details, and a polished visual presentation aimed at a premium buyer audience.',
  },
  {
    id: 'yrimports',
    title: 'YR Imports',
    category: 'Web Development',
    tags: ['React', 'Node.js', 'Tailwind CSS'],
    image: '/projects/yrimports.png',
    description: 'A business site for a Jamaica-based luxury and performance car importer.',
    fullDescription: 'A business site for a Jamaica-based luxury and performance car importer, featuring a showroom section highlighting certified new and pre-owned JDM, Euro, and SUV imports, along with service and customs-clearance information for international buyers.',
  },
  {
    id: 'primass',
    title: 'PRIMASS Japan (Tribisel Frontend)',
    category: 'Web Development',
    tags: ['React', 'Node.js', 'Tailwind CSS'],
    image: '/projects/primass%20japan.png',
    description: 'A search-engine-driven site for a Japanese used-car export company.',
    fullDescription: 'A site for a Japanese used-car export company, built around a search-engine-driven interface that lets international buyers browse and filter Japan-sourced used vehicles for export.',
  },
];
